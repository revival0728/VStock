namespace VStock
{
    partial class HomePage
    {
        ...
        private void InitializeComponent()
        {
            ...
            HistoryView.Location = new Point(18, 40);
            HistoryView.Margin = new Padding(2);
            HistoryView.MultiSelect = false;
            HistoryView.Name = "HistoryView";
            HistoryView.Size = new Size(356, 331);
            ...
            SearchArea.Location = new Point(395, 40);
            SearchArea.Margin = new Padding(2);
            SearchArea.Name = "SearchArea";
            SearchArea.Padding = new Padding(2);
            SearchArea.Size = new Size(298, 178);
            ...
            DateTo.Location = new Point(63, 142);
            DateTo.Margin = new Padding(2);
            DateTo.Name = "DateTo";
            DateTo.Size = new Size(196, 23);
            DateTo.TabIndex = 6;
            // 
            // label3
            // 
            ...
            DateFrom.Location = new Point(63, 116);
            DateFrom.Margin = new Padding(2);
            DateFrom.Name = "DateFrom";
            DateFrom.Size = new Size(196, 23);
            DateFrom.TabIndex = 4;
            // 
            // SHistory
            // 
            SHistory.AutoSize = true;
            SHistory.Location = new Point(12, 93);
            SHistory.Margin = new Padding(2);
            SHistory.Name = "SHistory";
            SHistory.Size = new Size(73, 19);
            SHistory.TabIndex = 3;
            SHistory.Text = "歷史資料";
            ...
            SRealTime.Location = new Point(12, 70);
            SRealTime.Margin = new Padding(2);
            SRealTime.Name = "SRealTime";
            SRealTime.Size = new Size(73, 19);
            ...
            StockIdInput.Location = new Point(71, 34);
            StockIdInput.Margin = new Padding(2);
            StockIdInput.Name = "StockIdInput";
            StockIdInput.Size = new Size(209, 23);
            StockIdInput.TabIndex = 0;
            StockIdInput.KeyDown += StockIdInput_KeyDown;
            // 
            // SearchList
            // 
            SearchList.Location = new Point(395, 224);
            SearchList.Margin = new Padding(2);
            SearchList.Name = "SearchList";
            SearchList.Size = new Size(298, 48);
            ...
            // SListAdd
            // 
            SListAdd.Location = new Point(407, 284);
            SListAdd.Margin = new Padding(2);
            SListAdd.Name = "SListAdd";
            SListAdd.Size = new Size(126, 36);
            SListAdd.TabIndex = 4;
            ...
            // SListDel
            // 
            SListDel.Location = new Point(552, 284);
            SListDel.Margin = new Padding(2);
            SListDel.Name = "SListDel";
            SListDel.Size = new Size(123, 36);
            SListDel.TabIndex = 5;
            SListDel.Text = "從列表刪除";
            ...
            // SearchVStock
            // 
            SearchVStock.Location = new Point(552, 333);
            SearchVStock.Margin = new Padding(2);
            SearchVStock.Name = "SearchVStock";
            SearchVStock.Size = new Size(123, 37);
            ...
            // SearchTrad
            // 
            SearchTrad.Location = new Point(407, 333);
            SearchTrad.Margin = new Padding(2);
            SearchTrad.Name = "SearchTrad";
            SearchTrad.Size = new Size(126, 37);
